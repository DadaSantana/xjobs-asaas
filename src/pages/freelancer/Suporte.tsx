        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <p className="font-medium text-gray-900 text-sm">Como recebo meus pagamentos?</p>
                <p className="text-gray-600 text-xs mt-1">Os pagamentos são processados automaticamente após a conclusão dos projetos.</p>
              </div>
              
              <div>
                <p className="font-medium text-gray-900 text-sm">Como atualizo meu perfil?</p>
                <p className="text-gray-600 text-xs mt-1">Acesse "Meu Perfil" no menu lateral para editar suas informações.</p>
              </div>
              
              <div>
                <p className="font-medium text-gray-900 text-sm">Posso cancelar um projeto?</p>
                <p className="text-gray-600 text-xs mt-1">Entre em contato conosco para avaliar a situação do projeto.</p>
              </div>
            </CardContent>
          </Card>
        </div>
