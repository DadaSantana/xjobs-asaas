...
const FreelancerStepsSection = () => {
  const steps = [
    {
      number: "01",
      title: "Cadastre-se",
      description: "Basta clicar em cadastre-se e preencher os campos como nome, e-mail, etc. Depois, na área de membros, você cria o seu perfil e portfólio.",
      icon: "👤",
    ...
    },
    {
      number: "02",
      title: "Propostas",
      description: "Em seguida, é só entrar na página 'projetos', selecionar a categoria e curtir o trabalho que você tem interesse. A sua proposta aparecerá logo abaixo dele, com uma descrição e o link do seu portfolio.",
      icon: "📋",
    ...
    },
    {
      number: "03",
      title: "Contato",
      description: "O cliente verá a sua proposta, quando você curtir o projeto. Ele entrará em contato e também poderá te achar pela área de membros.",
      icon: "🤝",
    ...
    },
    {
      number: "04",
      title: "Negociação",
      description: "O cliente negociará o trabalho pelo chat e pagará o valor pela plataforma. Os pagamentos são 100% seguros.",
      icon: "💰",
  ...
  return (
    <section id="freelancer-steps" className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 py-20 relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-blue-500/5 to-transparent transform -skew-y-12 translate-y-full animate-pulse"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 backdrop-blur-sm rounded-full px-6 py-2 mb-6 border border-blue-500/20">
            ...
            <span className="text-blue-100 text-sm font-medium">Para Freelancers Profissionais</span>
          </div>
          ...
          <p className="text-xl text-blue-100/70 max-w-2xl mx-auto leading-relaxed">
            Junte-se à elite de freelancers, que já descobriu como
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500/10 to-indigo-500/5 backdrop-blur-sm border border-blue-500/20 p-1">
                <div className="relative overflow-hidden rounded-2xl">
                  <img
                    src="/lovable-uploads/d406a2c0-3aeb-4317-ab32-712dc880ebc2.png"
                    alt="Freelancer de sucesso"
                  ...
                  {/* Floating stats */}
                  <div className="absolute top-6 right-6 bg-blue-500/10 backdrop-blur-md rounded-xl px-4 py-3 border border-blue-400/20">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">R$ 15k+</div>
                      <div className="text-xs text-blue-200/70">média mensal</div>
                    </div>
                  </div>

                  <div className="absolute bottom-6 left-6 bg-blue-500/10 backdrop-blur-md rounded-xl px-4 py-3 border border-blue-400/20">
                    <div className="flex items-center gap-2">
                      <div className="w-3 h-3 bg-blue-400 rounded-full animate-pulse"></div>
                      <span className="text-white text-sm font-medium">Ativo agora</span>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex gap-1">
                        {[...Array(4)].map((_, i) => (
                          <div
                            key={i}
                            className={`w-2 h-1 rounded-full transition-all duration-500 ${i <= index
        ...
        <div className="text-center mt-16">
          <Link to="/login">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full px-8 py-4 hover:scale-105 transition-transform duration-300 cursor-pointer group">
              <span className="text-white font-semibold">Comece agora, Gratuitamente</span>
...
export default FreelancerStepsSection;
